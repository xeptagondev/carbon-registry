...
@ValidatorConstraint()
export class CreditCalculationPropertyValidator
  implements ValidatorConstraintInterface
{
  validate(value: any, args: ValidationArguments) {
    ...
    if (NDCActionDto.subTypeOfMitigation) {
      if (NDCActionDto.subTypeOfMitigation == SubTypeOfMitigation.RICE_CROPS) {
        ...
        return (
          riceCropsProperties?.landArea !== undefined &&
          riceCropsProperties?.landAreaUnit !== undefined
        );
      } else if (
        ...
        const soilEnhancementBiocharProperties =
          args.value as SoilEnhancementBiocharProperties;
        return soilEnhancementBiocharProperties?.weight !== undefined;
      } else if (
        NDCActionDto.subTypeOfMitigation ==
        SubTypeOfMitigation.STOVES_HOUSES_IN_NAMIBIA
      ) {
        const stovesHousesInNamibiaProperties =
          args?.value as StovesHousesInNamibiaProperties;
        return (
          stovesHousesInNamibiaProperties?.numberOfDays !== undefined &&
          stovesHousesInNamibiaProperties?.numberOfPeopleInHousehold !==
            undefined
        );
      } else if (
        NDCActionDto.subTypeOfMitigation ==
        ...
        const solarWaterPumpOffGridProperties =
          args?.value as SolarWaterPumpOffGridProperties;
        const unit: EnergyGenerationUnits =
          solarWaterPumpOffGridProperties?.energyGenerationUnit as EnergyGenerationUnits;
        return (
          solarWaterPumpOffGridProperties?.energyGeneration !== undefined &&
          solarWaterPumpOffGridProperties?.energyGenerationUnit !== undefined &&
        ...
        const solarWaterPumpOnGridProperties =
          args?.value as SolarWaterPumpOnGridProperties;
        const unit: EnergyGenerationUnits =
          solarWaterPumpOnGridProperties?.energyGenerationUnit as EnergyGenerationUnits;
        return (
          solarWaterPumpOnGridProperties?.energyGeneration !== undefined &&
          solarWaterPumpOnGridProperties?.energyGenerationUnit !== undefined &&
          Object.values(EnergyGenerationUnits).includes(unit)
        );
      } else if (
        NDCActionDto.subTypeOfMitigation ==
        ...
        const solarCreditCalculationProperties =
          args?.value as SolarCreditCalculationProperties;
        return (
          solarCreditCalculationProperties?.energyGeneration !== undefined &&
          solarCreditCalculationProperties?.energyGenerationUnit !==
            undefined &&
          solarCreditCalculationProperties?.consumerGroup !== undefined
        );
      }
    }
    return true;
  ...
  defaultMessage(args: ValidationArguments) {
    ...
    if (
      childClass.subTypeOfMitigation == undefined ||
      childClass.subTypeOfMitigation == null
    ) {
    ...
    if (childClass.subTypeOfMitigation == SubTypeOfMitigation.RICE_CROPS) {
      ...
      childClass.subTypeOfMitigation ==
      SubTypeOfMitigation.SOIL_ENRICHMENT_BIOCHAR
    ) {
      ...
      if (
        !Object.values(EnergyGenerationUnits).includes(
          childClass.energyGenerationUnit
        )
      ) {
        return (
          "Invalid energyGenerationUnit. Supported following values:" +
          Object.values(EnergyGenerationUnits)
        );
      }
    } else if (
      childClass.subTypeOfMitigation ==
