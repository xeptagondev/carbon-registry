...
import {
  ...
  IsChildClassValid,
} from "../validation/credit.calculation.property.validator";
...
export class NDCActionDto {
  ...
  @IsEnum(NDCActionType, {
    message:
      "Invalid ndc action. Supported following roles:" +
      Object.values(NDCActionType),
  })
  ...
  @ValidateIf(
    (o) =>
      o.action === NDCActionType.Mitigation ||
      o.action === NDCActionType.CrossCutting
  )
  @IsEnum(TypeOfMitigation, {
    message:
      "Invalid mitigation type. Supported following values:" +
      Object.values(TypeOfMitigation),
  })
  @IsNotEmpty()
  ...
  @ValidateIf(
    (o) =>
      (o.action === NDCActionType.Mitigation ||
        o.action === NDCActionType.CrossCutting) &&
      o.typeOfMitigation !== TypeOfMitigation.CCS &&
      o.typeOfMitigation !== TypeOfMitigation.MARINE
  )
  @IsEnum(SubTypeOfMitigation, {
    message:
      "Invalid sub mitigation type. Supported following values:" +
      Object.values(SubTypeOfMitigation),
  })
  @IsNotEmpty()
  ...
  @ValidateIf(
    (o) =>
      o.typeOfMitigation === TypeOfMitigation.AGRICULTURE &&
  ...
  @ValidateIf(
    (o) =>
      o.typeOfMitigation === TypeOfMitigation.SOLAR &&
      o.subTypeOfMitigation === SubTypeOfMitigation.SOLAR_PHOTOVOLTAICS_PV
  )
  @IsNotEmptyObject()
  @ValidateNested()
  ...
  @ValidateIf(
    (o) =>
      o.action === NDCActionType.Adaptation ||
      o.action === NDCActionType.CrossCutting
  )
  @ValidateNested()
